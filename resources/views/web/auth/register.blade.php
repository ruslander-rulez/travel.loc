...
<div class="limiter">
    <div class="container-login100">
        <div class="wrap-login100 p-l-50 p-r-50 p-t-77 p-b-30">
            <form class="login100-form validate-form" method="post" action="{{ route("web.register") }}">
                    @csrf
                ...
                <div class="wrap-input100 validate-input m-b-16" data-validate = "Password confirmation does not match password">
                ...
                <div class="text-center w-full p-t-50">
                    ...
                    <a class="txt1 bo1 hov1" href="{{ route("web.login") }}">
                        Login now
                    </a>
                </div>
            </form>
