<template>
    ...
    <div class="portlet light bordered">
            ...
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-md-12">
                     ...
                     <div class="col-md-6">
                        <div class="btn-group">
                            <button id="sample_editable_1_new" class="btn sbold green" v-on:click="showNewForm=true"> Новый отель
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column dataTable no-footer"
                        ...
                        <tbody>
                            ...
                            <hotel-row
                                    ...
                                    v-bind:key="hotel.id"
                                    v-bind:inputEntity="hotel"
                                    v-on:remove="hotels.splice(index, 1)"
        ...
        <hotel-edit v-if="showNewForm" v-on:close="showNewForm=false" :inputEntity="defaultShip" v-on:created="created">
        </hotel-edit>
    </div>
...
<script>
    export default {
        ...
        methods: {
            ...
            created: function() {
                this.showAlert("Отель был создан")
                this.getData()
            },
            getData: function () {
                axios
