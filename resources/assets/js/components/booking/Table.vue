<template>
    ...
    <div class="portlet light bordered">
      <!--  <div class="portlet-title">
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column dataTable no-footer"
                        ...
                        <tbody>
                            <booking-row
                                    ...
                                    v-on:remove="bookings.splice(index, 1)"
        ...
        <booking-edit v-if="showNewForm"  v-on:close="showNewForm=false" :inputEntity="defaultBooking" v-on:created="created">
        </booking-edit>
    </div>
    ...
    export default {
        ...
        methods: {
            ...
            */
            ...
            created: function() {
                this.showAlert("Бронирование создано успешно")
                this.getData()
            },
            getData: function () {
                axios
