<template>
    ...
    <div class="portlet light bordered">
      <!--  <div class="portlet-title">
            ...
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-md-12">
                     ...
                     <div class="col-md-6">
                        <div class="btn-group">
                            <button id="sample_editable_1_new" class="btn sbold green" v-on:click="showNewForm=true"> Новое место
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column dataTable no-footer"
                        ...
                        <tbody>
                            ...
                            <place-row
                                    ...
                                    v-bind:key="place.id"
                                    v-bind:inputEntity="place"
                                    v-on:remove="places.splice(index, 1)"
        ...
        <place-edit v-if="showNewForm" v-on:close="showNewForm=false" :inputEntity="defaultPlace" v-on:created="created">
        </place-edit>
    </div>
...
<script>
    export default {
        ...
        methods: {
            ...
            created: function() {
                this.showAlert("Место было создано")
                this.getData()
            },
            getData: function () {
                axios
