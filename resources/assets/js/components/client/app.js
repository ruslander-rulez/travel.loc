...
Vue.component('client-table', require('./Table.vue').default);

Vue.component('client-row', require('./Row.vue').default);
Vue.component('client-edit', require('./Edit.vue').default);
