<template>
    ...
    <div class="portlet light bordered">
      <!--  <div class="portlet-title">
            ...
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-md-12">
                     ...
                     <div class="col-md-6">
                        <div class="btn-group">
                            <button id="sample_editable_1_new" class="btn sbold green" v-on:click="showNewForm=true"> Новый корабль
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column dataTable no-footer"
                        ...
                        <tbody>
                            ...
                            <ship-row
                                    ...
                                    v-bind:key="ship.id"
                                    v-bind:inputEntity="ship"
                                    v-on:remove="ships.splice(index, 1)"
        ...
        <ship-edit v-if="showNewForm" v-on:close="showNewForm=false" :inputEntity="defaultShip" v-on:created="created">
        </ship-edit>
    </div>
...
<script>
    export default {
        ...
        methods: {
            ...
            created: function() {
                this.showAlert("Корабль был создан")
                this.getData()
            },
            getData: function () {
                axios
